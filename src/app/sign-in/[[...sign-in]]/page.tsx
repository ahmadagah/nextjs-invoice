        ...
        >
          <header className='text-center'>
            <svg
              ...
              viewBox='0 0 24 24'
            >
              <path d='M13.4 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-7.4M2 6h4M2 10h4M2 14h4M2 18h4'></path>
          ...
          <div className='p-5'>
            <p className='mb-4 text-center text-sm/5 text-neutral-500'>
              Alternatively, sign in with these
              platforms
            </p>
          ...
          <SignIn.Strategy name='phone_code'>
            ...
            <Clerk.Field name='code'>
              ...
              <Clerk.Input
                ...
                className='w-full border-l-2 h-9 rounded-md ring-2 ring-inset ring-zinc-500 border-2 border-zinc-400  bg-white pb-2 text-sm/6 text-neutral-950 outline-none placeholder:text-neutral-400 hover:border-neutral-300 focus:border-neutral-600 data-[invalid]:border-red-600 data-[invalid]:text-red-600'
              />
              <Clerk.FieldError className='mt-2 block text-xs text-red-600' />
            </Clerk.Field>
            <SignIn.Action
